 ...
 * then you would look and the next highest fee bucket, and so on, stopping at
 ...
 * we count the number of transactions in each bucket, the total amount of fee
 * paid in each bucket. Then we calculate how many blocks Y it took this
 ...
 * keep track of the number of as of yet unmined transactions in each bucket
